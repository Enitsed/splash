...
class MySQLConnector {
    ...
    get MYSQL_DB_USER() { return process.env.DB_USER || 'root' }
    get MYSQL_DB_NAME() { return process.env.DB_DATABASE || 'exapp' }
    get MYSQL_DB_PASSWORD() { return process.env.DB_PASSWORD || '' }
    get MYSQL_DB_ADDRESS() { return process.env.DB_HOST || 'localhost' }
